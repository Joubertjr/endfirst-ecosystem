...
- [ ] Você criou uma Matriz de Decisão para cada trade-off?
- [ ] Você tomou uma decisão clara (manter, cortar, adiar)?
- [ ] O escopo do projeto agora é realista?

---

## 🏁 Definition of Done (DoD)

"O Pilar 3 está pronto quando: (1) Todos os trade-offs foram analisados, (2) Decisões claras foram tomadas, (3) O escopo do projeto é realista e executável."

---

## 🏆 Critérios de Qualidade

- **Racionalidade:** As decisões foram baseadas em critérios objetivos, não em emoção?
- **Coragem:** Você teve coragem de cortar features que ama, mas que não são essenciais?
- **Clareza:** O escopo final está claro e bem definido?
