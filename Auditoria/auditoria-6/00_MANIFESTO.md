...
| Métrica | Valor |
|---------|-------|
| Personas auditadas | 1 (PERSONAS) |
| Arquivos auditados | 34 |
| Total de achados | 23 |
| **BLOQUEIOS** | **0** |
| ALTAS | 0 |
| MÉDIAS | 0 |
...
| BLOCO 1 | Estrutura | ❌ FAIL |
| BLOCO 2 | Inventário de Arquivos | ❌ FAIL |
| BLOCO 3 | Conteúdo por Arquivo | ❌ FAIL (34 arquivos FAIL) |
...
- **34 arquivos** sem todos os requisitos obrigatórios
- Arquivos afetados:
...
**Status:** ❌ REPROVADO  
**Motivo:** BLOCO 1 FAIL + BLOCO 2 FAIL + BLOCO 3 FAIL  
